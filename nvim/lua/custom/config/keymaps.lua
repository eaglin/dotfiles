...
----- Tmux Navigation ------
-- local nvim_tmux_nav = require 'nvim.lua.custom.plugins.nvim-tmux-navigation'
--
...
vim.keymap.set('v', '<leader>sg', function()
  ...
  if pcall(require, 'snacks') then
    require('nvim.lua.custom.plugins.quicker').picker.grep { search = selected_text }
...
vim.keymap.set('v', '<leader>sG', function()
  ...
  if pcall(require, 'snacks') then
    require('nvim.lua.custom.plugins.quicker').picker.grep { search = selected_text, cwd = root }
  elseif pcall(require, 'fzf-lua') then
